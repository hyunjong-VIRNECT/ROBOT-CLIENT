...
def spot_control_power_off():
    print("call_safe_power_off()")
    wasd_interface._call_power_off()
...
VELOCITY_CMD_DURATION = 0.8  # command duration 0.6 seconds
...
class WasdInterface(object):
    ...
    def _call_spot_replay_mission(self, data):
        # data -> /path/to/autowalk.walk
        path = "/home/virnect/Documents/autowalk_path/" + data
...
def main():
    ...
    #socket.connect('https://192.168.11.70:3458')
